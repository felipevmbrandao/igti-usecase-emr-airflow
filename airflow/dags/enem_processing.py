...
def pipeline_enem():
    ...
    def emr_process_enem_data():
        cluster_id = client.run_job_flow(
            Name='EMR-Brandao-IGTI-delta',
            ServiceRole='EMR_DefaultRole',
            JobFlowRole='EMR_EC2_DefaultRole',
            VisibleToAllUsers=True,
            LogUri='s3://datalake-fbrandao-igti-tf/emr-logs',
            ...
            Instances={
                ...
                'Ec2KeyName': 'brandao_igti_teste2',
                'KeepJobFlowAliveWhenNoSteps': True,
                'TerminationProtected': False,
                'Ec2SubnetId': 'subnet-68ceb324'
            },
            ...
            Steps=[{
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit',
                            ...
                            '--master', 'yarn',
                            '--deploy-mode', 'cluster',
                            's3://datalake-fbrandao-igti-tf/emr-code/pyspark/01_delta_spark_insert.py'
                        ]
                }
            }],
        )
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                ...
                                '--master', 'yarn',
                                '--deploy-mode', 'cluster',
                                's3://datalake-fbrandao-igti-tf/emr-code/pyspark/02_delta_spark_upsert.py'
                            ]
                    }
                }]
            )
